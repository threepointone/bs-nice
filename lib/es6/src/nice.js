...
import * as Helpers$Nice            from "./helpers.js";
...
function css(decls) {
  ...
  var className = "css-" + Helpers$Nice.base62_of_int(Hashtbl.hash(flattened));
  if (!Hashtbl.mem(injected, flattened)) {
    ...
    Hashtbl.add(injected, flattened, /* true */1);
  }
  return className;
}
...
function fontFace() {
  ...
  return Curry._1(class_tables$3[0], 0);
}
...
function rehydrate() {
  ...
  return Curry._1(class_tables$4[0], 0);
}
