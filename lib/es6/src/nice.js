...
function css(decls) {
  var className = "css-" + Pervasives.string_of_int(Hashtbl.hash(decls));
  var css$1 = $$String.concat("; ", List.map(string_of_style, decls));
  Curry._1(insertRule, "." + className + "{" + css$1 + "}");
  return className;
}
